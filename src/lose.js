...
var lose = cc.Layer.extend({
    ctor: function() {
        ...
        if (!audioEngine.isMusicPlaying()) {
          ...
          audioEngine.playMusic(res.over_mp3 , true);
        }
        ...
        //ステージ選択へ
        var sentaku01 = cc.Sprite.create(res.sentaku_png);　
        sentaku01.setPosition(size.width * 0.5, size.height * 0.3);
        this.addChild(sentaku01);

        //ゲームオーバー
        gameover = cc.LabelTTF.create("GAME OVER", "Arial", 40);
        gameover.setColor(255,255,255);
        this.addChild(gameover); //文字つける時はこっち*/
        gameover.setPosition(size.width * 0.5,size.height * 0.7, 15);
