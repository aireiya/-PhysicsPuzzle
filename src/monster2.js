...
//モンスタークラス
var Monster2 = cc.Class.extend({ // cc.Classを継承
   ...
   ctor: function(parent, posX, posY, tag) { // コンストラクタ
     ...
     this.spriteSheet = new cc.SpriteBatchNode(res.monster2_png);
     // ランニングアクションを初期化
     var animFrames = [];
     for (var i = 0; i < 7; i++) {
        var spriteFrame = new cc.SpriteFrame(res.monster2_png, cc.rect(60 * i, 0, 60, 60));
          var str = "monsterB" + i;
      ...
      this.sprite = cc.Sprite.create('#monsterB0');
